<script lang="ts">
	import scoreboard2024 from '$lib/scores/scoreboard_2024.json';

	type Scoreboard = typeof scoreboard2024;

	const sortScoreboard = (scoreboard: Scoreboard) =>
		scoreboard.toSorted((a, b) => b.score - a.score);

	let orderedScores = $derived(sortScoreboard(scoreboard2024));
</script>

<h2 class="mb-8 text-center text-3xl font-bold">Classifica CyberCup.IT 2024:</h2>
